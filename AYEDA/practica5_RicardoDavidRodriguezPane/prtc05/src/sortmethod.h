...
class MethodSelection : public SortMethod<Key> {
 public:
  ...
  void Sort() override { SelectionSort<Key> ordenacion(this->secuencia_, this->size_); };
};
...
class MethodBubble : public SortMethod<Key> {
 public:
  ...
  void Sort() override { BubbleSort<Key> ordenacion(this->secuencia_, this->size_); };
};
...
class MethodMerge : public SortMethod<Key> {
 public:
  ...
  void Sort() override { MergeSort<Key> ordenacion(this->secuencia_, this->size_); };
};
...
class MethodHeap : public SortMethod<Key> {
 public:
  ...
  void Sort() override { HeapSort<Key> ordenacion(this->secuencia_, this->size_); };
};
...
class MethodShell : public SortMethod<Key> {
 public:  MethodShell(StaticSeq<Key>& secuencia, unsigned size, double alpha) : SortMethod<Key>(secuencia, size), alpha_(alpha) {};
  void Sort() override { ShellSort<Key> ordenacion(this->secuencia_, this->size_, alpha_); };
 private:
  double alpha_;
};